...
const appPathPattern = /^(?:\/(?:feed|friends|liked|recommendations|top|admin|search)\/?|\/users\/[A-Za-z0-9_.-]{3,32}\/?|\/share\/[A-Za-z0-9_-]{20,80}\/?|\/)$/

export function isAppPath(pathname: string) {
  return appPathPattern.test(pathname)
}
